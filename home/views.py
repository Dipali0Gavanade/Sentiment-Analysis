...
def livetweets(request):
    if(request.session.has_key('account_id')):
        ...
        if(request.method == 'POST'):
            ...
            consumer_key = 'W2tbWrf7ONt02nDrSQu9zrQll'
            consumer_key_secret = 'XWYINko87mwIR3IIeNhBy39mpCdg5YV1hTgSLrafRzCvu7jM6J'
            access_token = '2895910574-26Ugn6KMHAlFwa4NoWZKQCgtNGebwIqxHSLVXvV'
            access_token_secret = 'mNTvh27fKMbMKWMHNREQWThZpI097liKx4HKTflagNORx'
